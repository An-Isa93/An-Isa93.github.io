...
void imprimir()
{
   ...
   if (primero == ultimo) {
     int id_impreso = primero->dato;//obtiene el ID del documento a imprimir
      delete primero;//elimina el unico elemento de la lista
      primero = ultimo = NULL;// establece el primero y ultimo como null
      cout << "DOCUMENTO "<<id_impreso<<" IMPRESO CORRECTAMENTE."<<endl<<"COLA DE IMPRESION VACIA" << endl;
      return;
   }
   ...
   cout <<"DOCUMENTO "<<id_impreso<<" IMPRESO CORRECTAMENTE."<<endl;
}
...
int main()
{
    ...
    switch(op)
    {
        ...
        break;
        case 3:
        cout<<"VER COLA DE IMPRESION"<<endl;
        listar();
        cout<<endl;
        system("pause");
        break;
